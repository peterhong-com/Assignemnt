...
public class activity_student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        a2=findViewById(R.id.editTextTextPersonName21);
        a3=findViewById(R.id.editTextTextPersonName31);
        a4=findViewById(R.id.editTextDate1);
        a5=findViewById(R.id.editTextTextPersonName41);
        a6=findViewById(R.id.editTextTextPersonName51);
        btnChild = findViewById(R.id.btnSubmit);
